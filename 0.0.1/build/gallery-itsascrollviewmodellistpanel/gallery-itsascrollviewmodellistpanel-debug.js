...
Y.ITSAScrollViewModellistPanel = Y.Base.create('itsascrollviewmodellistpanel', Y.ITSAScrollViewModellist, [
    ...
    initializer : function() {
        ...
        Y.log('initializer', 'info', 'Itsa-ScrollViewModellistPanel');
    ...
    */
    _extraBindUI : function() {
        ...
        Y.log('_extraBindUI', 'info', 'Itsa-ScrollViewModellistPanel');
    ...
    */
    _addModel : function() {
        ...
        Y.log('_addModel', 'info', 'Itsa-ScrollViewModellistPanel');
        if (modellist) {
    ...
    */
    _closeList : function() {
        ...
        Y.log('_closeList', 'info', 'Itsa-ScrollViewModellistPanel');
        instance.hide();
    ...
    */
    _getViewContainer : function() {
        Y.log('_getViewContainer', 'info', 'Itsa-ScrollViewModellistPanel');
    ...
    */
    _widgetRenderer : function() {
        ...
        Y.log('_widgetRenderer', 'info', 'Itsa-ScrollViewModellistPanel');
    ...
    _setZIndex: function(zIndex) {
        Y.log('_setZIndex', 'info', 'Itsa-ScrollViewModellistPanel');
    ...
    _uiSetXY : function(val) {
        ...
        Y.log('_uiSetXY', 'info', 'Itsa-ScrollViewModellistPanel');
