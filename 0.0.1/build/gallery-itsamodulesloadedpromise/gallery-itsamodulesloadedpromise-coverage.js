...
return new Y.Promise(function (resolve, reject) {
        _yuitest_coverfunc("build/gallery-itsamodulesloadedpromise/gallery-itsamodulesloadedpromise.js", "(anonymous 2)", 39);
_yuitest_coverline("build/gallery-itsamodulesloadedpromise/gallery-itsamodulesloadedpromise.js", 40);
[].push.apply(
            args,
            [
                function(Y, status) {
                    _yuitest_coverfunc("build/gallery-itsamodulesloadedpromise/gallery-itsamodulesloadedpromise.js", "(anonymous 3)", 43);
_yuitest_coverline("build/gallery-itsamodulesloadedpromise/gallery-itsamodulesloadedpromise.js", 44);
resolve(status);
                }
            ]
        );
...
Y.use.apply(Y, args);
        _yuitest_coverline("build/gallery-itsamodulesloadedpromise/gallery-itsamodulesloadedpromise.js", 49);
Y.later(
            TIMEOUT,
            null,
            reject,
