YUI.add('module-tests', function(Y) {
    ...
    suite.add(new Y.Test.Case({
        ...
        'check widget.hasPlugin normal way':  function() {
            ...
            Y.Assert.isNotUndefined(cal.hasPlugin('dd'), 'widget.hasPlugin returned false when using widget.plug()');
        }
    }));
    ...
    suite.add(new Y.Test.Case({
        ...
        'check widget.hasPlugin when pluggedin after render':  function() {
            ...
            Y.Assert.isUndefined(cal.hasPlugin('dd'), 'widget.hasPlugin returned false when using widget.plugAfterRenderPromise()');
        }
    }));
    ...
    suite.add(new Y.Test.Case({
        ...
        'check widget.hasPlugin when pluggedin after render and check after render':  function() {
            ...
            cal.renderPromise().then(
                function() {
                    Y.Assert.isNotUndefined(cal.hasPlugin('dd'), 'widget.hasPlugin returned false when using widget.plugAfterRenderPromise() and checked after the sidget was rendered.');
                },
                function(reason) {
