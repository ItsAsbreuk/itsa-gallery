{
    ...
    checkspambox: 'Wanneer u geen email van ons heeft ontvangen, controleer dan uw spambox',
    confirmpassword: 'Bevestig wachtwoord',
    createaccount: 'Aanmaken account',
    createnewaccount: 'Aanmaken nieuw account',
    email: 'Email',
    emailaddress: 'Emailadres',
    emailalreadytaken: 'Emailadres is al in gebruik, kies een ander emailadres',
    enterlogin: 'Invoeren login',
    entersignupaddress: 'Voer het emailadres in dat u gebruikte bij de aanmelding',
    error: 'Fout',
    failed: 'Mislukt',
    failedcreateaccount: 'Aanmaken van nieuw account is mislukt, probeer opnieuw',
    forgot: 'Vergeten',
    forgotlogin: 'Login-gegevens vergeten',
    forgotpassword: 'Wachtwoord vergeten',
    forgotusername: 'Gebruikersnaam vergeten',
    forgotusernameorpassword: 'Gebruikersnaam of wachtwoord vergeten',
    ...
    passwordchanged: 'Uw wachtwoord is met succes gewijzigd',
    passwordnotaccepted: 'Uw wachtwoord is niet geaccepteerd, probeer opnieuw',
    passwordnotchanged: 'Uw wachtwoord is niet aangepast',
    passwordwassend: 'Uw wachtwoord is naar uw emailadres verstuurd',
    pleaseenterlogin: 'Geef de login-gegevens',
    remember: 'Onthoud',
    ...
    retrievepasswordinstructionsmaillogin: 'Voer het emailadres in dat u gebruikte bij de aanmelding en u ontvangt een email met nadere instructies hoe u uw wachtwoord kunt herstellen',
    sendusername: 'Verstuur gebruikersnaam',
    show: 'Laat zien',
    ...
    unknownusername: 'De gebruikersnaam die u invoerde is bij ons onbekend, probeer opnieuw',
    unspecifiederror: 'De server retourneerde een niet nader gespecificeerde fout',
    username: 'Gebruikersnaam',
    usernamealreadytaken: 'Gebruikersnaam is al in gebruik, kies een andere gebruikersnaam',
    usernamewassend: 'Uw gebruikersnaam is naar uw emailadres verstuurd',
    verificationerror: 'Wachtwoordverificatie mislukt',
    verify: 'Controleer',
