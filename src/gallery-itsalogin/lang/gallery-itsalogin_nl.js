{
    ...
    entersignupaddress: 'Geef het emailadres dat u gebruikte bij de aanmelding',
    error: 'Fout',
    forgot: 'Vergeten',
    ...
    retrievepasswordinstructions: 'U zult een email ontvangen met nadere instructies hoe u uw wachtwoord kunt herstellen',
    show: 'Laat zien',
