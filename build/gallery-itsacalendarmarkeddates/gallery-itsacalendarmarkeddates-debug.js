...
Y.mix(ITSACalendarMarkedDates.prototype, {
    ...
    initializer : function () {
        ...
        Y.log('initializer', 'info', 'Itsa-CalendarMarkedDates');
    ...
    destructor: function () {
        ...
        Y.log('destructor', 'info', 'Itsa-CalendarMarkedDates');
    ...
    getMarkedDates : function (aDate, bDate) {
        ...
        Y.log('getMarkedDates', 'info', 'Itsa-CalendarMarkedDates');
    ...
    getMarkedDatesInWeek : function (oDate) {
        ...
        Y.log('getMarkedDatesInWeek from '+aDate+' to '+bDate, 'warn', 'Itsa-CalendarMarkedDates');
    ...
    getMarkedDatesInMonth : function (oDate) {
        ...
        Y.log('getMarkedDatesInMonth', 'info', 'Itsa-CalendarMarkedDates');
        aDate.setDate(1);
        bDate.setDate(1);
        dateAddDays(bDate, -1);
        Y.log('getMarkedDatesInMonth from '+aDate+' to '+bDate, 'warn', 'Itsa-CalendarMarkedDates');
        return instance.getMarkedDates(aDate, bDate);
    },
    ...
    getMarkedDatesInYear : function (year) {
        ...
        Y.log('getMarkedDatesInYear from '+aDate+' to '+bDate, 'warn', 'Itsa-CalendarMarkedDates');
        return instance.getMarkedDates(aDate, bDate);
    },
    ...
    dateIsMarked : function (oDate) {
        ...
        Y.log('dateIsMarked check '+oDate+' result: '+isMarked, 'warn', 'Itsa-CalendarMarkedDates');
        return isMarked;
    },
    ...
    markDates : function (dates) {
        ...
        Y.log('markDates', 'info', 'Itsa-CalendarMarkedDates');
    ...
    unmarkDates : function (dates) {
        ...
        Y.log('unmarkDates', 'info', 'Itsa-CalendarMarkedDates');
        if (!dates) {
    ...
    clearMarkedDates : function (noevent) {
        ...
        Y.log('clearMarkedDates noevent='+noevent, 'info', 'Itsa-CalendarMarkedDates');
        instance._markedDates = {};
        if (noevent) {
            instance.get('contentBox').all('.' + CAL_DAY_MARKED).removeClass(CAL_DAY_MARKED);
        }
        else {
            Y.log('clearMarkedDates will fire a markChange event', 'info', 'Itsa-CalendarMarkedDates');
    ...
    _fireMarkChange : function (prevMarked) {
        ...
        */
        ...
        Y.log('_fireMarkChange', 'info', 'Itsa-CalendarMarkedDates');
    ...
    _getMarkedDatesList : function () {
        ...
        Y.log('_getMarkedDatesList', 'info', 'Itsa-CalendarMarkedDates');
    ...
    _addDateToMarked : function (oDate, index) {
        ...
        if (!YDate.isValidDate(oDate)) {
            Y.log('_addDateToMarked --> no valid date', 'warn', 'Itsa-CalendarMarkedDates');
        }
        else {
            Y.log('_addDateToMarked '+oDate+'with event: '+index, 'info', 'Itsa-CalendarMarkedDates');
            ...
            if (!Lang.isValue(index)) {
                Y.log('_addDateToMarked will fire a markChange event', 'info', 'Itsa-CalendarMarkedDates');
                instance._fireMarkChange(prevMarked);
            }
        }
    },
    ...
    _addDatesToMarked : function (datesArray) {
        ...
        Y.log('_addDatesToMarked', 'info', 'Itsa-CalendarMarkedDates');
        arrayEach(datesArray, instance._addDateToMarked, instance);
        Y.log('_addDatesToMarked will fire a markChange event', 'info', 'Itsa-CalendarMarkedDates');
        instance._fireMarkChange(prevMarked);
    },
    ...
    _addDateRangeToMarked : function (startDate, endDate) {
        ...
        Y.log('_addDateRangeToMarked', 'info', 'Itsa-CalendarMarkedDates');
        ...
        Y.log('_addDateRangeToMarked will fire a markChange event', 'info', 'Itsa-CalendarMarkedDates');
        instance._fireMarkChange(prevMarked);
    },
    ...
    _removeDateFromMarked : function (oDate, index) {
        ...
        Y.log('_removeDateFromMarked with event: '+index, 'info', 'Itsa-CalendarMarkedDates');
        if (!YDate.isValidDate(oDate)) {
            Y.log('_removeDateFromMarked --> no valid date', 'warn', 'Itsa-CalendarMarkedDates');
        }
        else {
            if (hasKey(instance._markedDates, year) &&
                ...
                hasKey(instance._markedDates[year][month], day))
            {
                if (Lang.isValue(index)) {
                    ...
                    prevMarked = instance._getMarkedDatesList();
                    delete instance._markedDates[year][month][day];
                    Y.log('_removeDateFromMarked will fire a markChange event', 'info', 'Itsa-CalendarMarkedDates');
                    instance._fireMarkChange(prevMarked);
                }
            }
        }
    ...
    _removeDateRangeFromMarked : function (startDate, endDate) {
        ...
        Y.log('_removeDateRangeFromMarked', 'info', 'Itsa-CalendarMarkedDates');
        for (time = startTime; time <= endTime; time += 86400000) {
            instance._removeDateFromMarked(new Date(time));
        }
        Y.log('_removeDateRangeFromMarked will fire a markChange event', 'info', 'Itsa-CalendarMarkedDates');
        instance._fireMarkChange(prevMarked);
    },
    ...
    _renderMarkedDates : function () {
        ...
        Y.log('_renderMarkedDates', 'info', 'Itsa-CalendarMarkedDates');
        instance.get('contentBox').all('.' + CAL_DAY_MARKED).removeClass(CAL_DAY_MARKED);
    ...
    _getDateColumn : function (oDate) {
        ...
        Y.log('_getDateColumn', 'info', 'Itsa-CalendarMarkedDates');
        switch (daymod) {
            case (0):
                if (cutoffCol >= 6) {
                    col = 12;
    ...
    */
    _renderMarkedDatesHelper: function (oDate) {
        ...
        Y.log('_renderMarkedDatesHelper', 'info', 'Itsa-CalendarMarkedDates');
    ...
    _getMarkedDatesInMonth : function (oDate) {
        ...
        Y.log('_getMarkedDatesInMonth', 'info', 'Itsa-CalendarMarkedDates');
