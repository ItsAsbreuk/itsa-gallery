...
this._selectItem(e.currentTarget, true);
        ...
        */
        selectItem : function(index, softMatch, softButtonText) {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "selectItem", 201);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 202);
var instance = this,
                nodelist = instance._itemsContainerNode.all('li');
            _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 204);
if ((index>=0) && (index<nodelist.size())) {instance._selectItem(nodelist.item(index));}
                ...
                _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 207);
if (softMatch) {
...
nodelist.removeClass(instance._selectedItemClass);
                    _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 209);
instance._selectedMainItemNode.setHTML(softButtonText ? softButtonText : instance.get('defaultButtonText'));
        ...
        */
        selectItemByValue : function(itemText, softMatch, defaultButtonText) {
            // by returnvalue 
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "selectItemByValue", 225);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 227);
var instance = this,
                index = Y.Array.indexOf(instance._itemValues, itemText.toString().toLowerCase());
            _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 229);
instance.selectItem(index, softMatch, defaultButtonText ? instance.get('defaultButtonText') : itemText);
        ...
        */
        _selectItem : function(node, userInteraction) {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "_selectItem", 244);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 245);
var instance = this,
                previousNode = instance._itemsContainerNode.one('li.'+instance._selectedItemClass),
                nodeHTML;
            _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 248);
...
if (previousNode) {previousNode.removeClass(instance._selectedItemClass);}
                _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 250);
node.addClass(instance._selectedItemClass);
                _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 251);
nodeHTML = node.getHTML();
                _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 252);
instance._selectedMainItemNode.setHTML(nodeHTML);
                _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 253);
instance.buttonNode.fire('valueChange', {currentTarget: instance, value: node.getData('returnValue') || nodeHTML, index: instance._indexOf(node)});
                _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 254);
if (userInteraction) {instance.buttonNode.fire('selectChange', {currentTarget: instance, value: node.getData('returnValue') || nodeHTML, index: instance._indexOf(node)});}
        ...
        */
        hideListbox : function() {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "hideListbox", 263);
...
this._itemsContainerNode.toggleClass(ITSA_CLASSHIDDEN, true);
        ...
        */
        showListbox : function() {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "showListbox", 272);
...
this._itemsContainerNode.toggleClass(ITSA_CLASSHIDDEN, false);
        ...
        */
        _toggleListbox : function() {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "_toggleListbox", 283);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 284);
this._itemsContainerNode.toggleClass(ITSA_CLASSHIDDEN);
        ...
        */
        currentSelected : function() {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "currentSelected", 293);
...
return this._itemsContainerNode.one('li.'+this._selectedItemClass);
        ...
        */
        currentIndex : function() {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "currentIndex", 304);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 305);
return this._indexOf(this.currentSelected());
        ...
        */
        _indexOf : function(node) {
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "_indexOf", 317);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 318);
var nodelist = this._itemsContainerNode.one('.itsa-selectlist-ullist').all('li');
            _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 319);
return nodelist.indexOf(node);
        ...
        */
        destructor : function() {
            ...
            _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "destructor", 329);
            ...
            */
            btnSize : {
                ...
                validator: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "validator", 346);
...
return (Lang.isNumber(val) && (val>0) && (val<4));
            ...
            */
            defaultButtonText : {
                value: 'choose...',
                validator: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "validator", 360);
...
return Y.Lang.isString(val);
            ...
            */
            buttonWidth: {
                value: null,
                validator: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "validator", 373);
...
return (Y.Lang.isNumber(val) && (val>=0));
            ...
            */
            listWidth: {
                value: null,
                validator: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "validator", 386);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 387);
return (Y.Lang.isNumber(val) && (val>=0));
                }
            },
            ...
            */
            listAlignLeft : {
                value: true,
                validator: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "validator", 399);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 400);
...
return Y.Lang.isArray(val);
                ...
                setter: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "setter", 438);
_yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 439);
var instance = this,
                        transformHandlebars = Lang.isString(instance.get('handleBars')),
                        item,
                        i;
                    _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 443);
instance._itemValues = [];
                    _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 444);
...
item = val[i];
                        ...
                        _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 447);
instance._itemValues.push(item.returnValue ? item.returnValue.toString().toLowerCase() : item.toString().toLowerCase());
                    ...
                    _yuitest_coverline("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", 450);
...
return Y.Lang.isBoolean(val);
                ...
                setter: function(val) {
                    _yuitest_coverfunc("/build/gallery-itsaselectlist/gallery-itsaselectlist.js", "setter", 479);
