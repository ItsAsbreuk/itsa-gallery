...
Y.ITSAViewModel = Y.Base.create('itsaviewmodel', Y.Widget, [], {
        ...
        */
        initializer : function() {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "initializer", 79);
...
var instance = this,
            ...
            _yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 89);
if (styled) {
                _yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 90);
boundingBox.addClass(MODELVIEW_STYLED);
            }
            _yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 92);
...
model.addTarget(view);
         ...
         */
        bindUI: function() {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "bindUI", 111);
...
eventhandlers.push(
                instance.after(
                    'modelChange',
                    function(e) {
                        _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "(anonymous 2)", 120);
_yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 121);
...
newVal.addTarget(view);
                        ...
                        _yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 129);
...
eventhandlers.push(
                instance.after(
                    'templateChange',
                    function(e) {
                        _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "(anonymous 3)", 137);
...
view.render();
            ...
            _yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 145);
eventhandlers.push(
                instance.after(
                    'eventsChange',
                    function(e) {
                        _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "(anonymous 4)", 148);
...
eventhandlers.push(
                instance.after(
                    'styledChange',
                    function(e) {
                        _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "(anonymous 5)", 156);
...
eventhandlers.push(
         ...
         */
        syncUI: function() {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "syncUI", 175);
...
this.view.render();
        ...
        */
        destructor: function() {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "destructor", 184);
...
instance.view.destroy();
        ...
        */
        _getModelToJSON : function(model) {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "_getModelToJSON", 207);
...
return (model.get && (Lang.type(model.get) === 'function')) ? model.toJSON() : model;
        ...
        */
        _setTemplateRenderer : function(template) {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "_setTemplateRenderer", 223);
...
isMicroTemplate = function() {
                _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "isMicroTemplate", 227);
...
instance._modelTemplate = function(model) {
                    _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "_modelTemplate", 233);
...
instance._modelTemplate = function(model) {
                    _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "_modelTemplate", 238);
...
return Lang.sub(template, instance._getModelToJSON(model));
        ...
        */
        _viewRenderer : function (clear) {
          _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "_viewRenderer", 254);
...
return instance;
        ...
        */
        _clearEventhandlers : function() {
            _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "_clearEventhandlers", 274);
_yuitest_coverline("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", 275);
YArray.each(
                this._eventhandlers,
                function(item){
                    _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "(anonymous 6)", 277);
...
item.detach();
        ...
        ATTRS : {
            ...
            events: {
                value: {},
                validator: function(v){ _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "validator", 327);
...
return Lang.isObject(v);}
            ...
            model: {
                value: null,
                validator: function(v){ _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "validator", 341);
            ...
            */
            styled: {
                ...
                validator:  function(v) {
                    _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "validator", 358);
...
return Lang.isBoolean(v);
         ...
         */
            template: {
                value: '{clientId}',
                validator: function(v){ _yuitest_coverfunc("build/gallery-itsaviewmodel/gallery-itsaviewmodel.js", "validator", 382);
